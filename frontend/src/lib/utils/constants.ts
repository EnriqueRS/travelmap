...
export const MAP_STYLES = {
  ...
  LIGHT: 'https://api.maptiler.com/maps/streets-v2-light/style.json?key=YOUR_API_KEY',
  SATELLITE: 'https://api.maptiler.com/maps/satellite/style.json?key=YOUR_API_KEY',
  OUTDOORS: 'https://api.maptiler.com/maps/outdoor-v2/style.json?key=YOUR_API_KEY'
};
